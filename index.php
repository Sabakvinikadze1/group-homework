          ...
          <form>
            ...
            <div class="form-row ">
              ...
              <div class="form-group col-lg-4">
                ...
                <?php 
                  for($i = 0; $i < sizeof($options); $i++) {
                    echo '<option value="Normal distribution ">' . $options[$i] . '</option> ';
                  } 
              ...
              <div class="form-group col-lg-4">
                ...
                <?php 
                 for($i =0; $i < sizeof($theOptions); $i++){
                  echo '<option value="Normal distribution "> '. $theOptions[$i] .' </option>';
